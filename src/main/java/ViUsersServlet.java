...
public class ViUsersServlet extends HttpServlet {
    /**
	 * 
	 */
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            out.println("<tr><th>Username</th><th>Email</th><th>USN</th><th>Phone No</th></tr>");
            while (rs.next()) {
                String username = rs.getString("username");
                String email = rs.getString("email");
                String usn = rs.getString("usn");
                String phoneno = rs.getString("phoneno");
                out.println("<tr><td>" + username + "</td><td>" + email + "</td><td>" + usn + "</td><td>" + phoneno + "</td></tr>");
            }
            out.println("</table>");
            out.println("<br>");
            ...
            out.println("<p>Error occurred while retrieving user information.</p>");
        } finally {
            // Closing resources
            try {
                if (rs != null) rs.close();
