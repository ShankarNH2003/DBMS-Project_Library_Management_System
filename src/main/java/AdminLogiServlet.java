...
public class AdminLogiServlet extends HttpServlet {
    /**
	 * 
	 */
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            String sql = "SELECT * FROM adminn WHERE username = ?";
            ...
            response.sendRedirect("adminlogin.html?error=1"); // You can customize the error parameter as needed
